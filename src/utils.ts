import {booleanToString, compact, keys} from "base/utils";
import {Children, SVGElementAttr, HTMLElementAttr, OneOrMany, JsonValue, SegmentType, Segment} from "types";
